...
setcookie(); // передать инфу в куксы
$_COOKIE //массив с куками

session_start(); // старт сессии. всегда в начале кода пхп
$_SESSION // массив с сессией
session_destroy(); // убить сессию

unset(); //Удалить что-то из массива